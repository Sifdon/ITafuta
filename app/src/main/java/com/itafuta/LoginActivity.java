...
public class LoginActivity extends AppCompatActivity {
    ...
    EasyTextInputLayout editLoginEmail;
    EasyTextInputLayout editLoginPassword;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editLoginEmail = (EasyTextInputLayout) findViewById(R.id.edit_login_email);
        editLoginPassword = (EasyTextInputLayout) findViewById(R.id.edit_login_password);
        ...
        txtWithoutSignIn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Log.d(TAG, "To main with not sign in");
    ...
    public void login(){
        ...
        String email = editLoginEmail.getEditText().toString();
        String password = editLoginPassword.getEditText().toString();
